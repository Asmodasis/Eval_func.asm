################################################################################
#
# Title:       Evaluation Function -- MIPS Assembly program
#
# Filename:    eval_func.asm
#
# Author:      Shawn Ray
#
# Date:        2018_02_09  -- 2018_03_15
#
# Description: This program asks for the coefficients of a polynomial and then 
#			solves it with an input value
#
# Input:       floating point values a, b , c for a polynomial in the form 
#			a*x^2+b*x+c
#
# Output:      floating point solutions to the polynomial -- solved with input 
#			and solved for roots (a*x^2+b*x+c = 0) both real and complex
#
#
################################################################################
